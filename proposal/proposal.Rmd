...
Therefore, we’ve selected the following variables from the data, including "total_cup_points", "species", "country_of_origin", "company", "altitude”, "harvest_year", "processing_method”, "variety", "color", "moisture".
